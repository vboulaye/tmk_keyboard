...
static const uint8_t keymaps[][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
     ...
     */
    [0] = KEYMAP(
    GRAVE, 1,   2,   3,   4,   5,   6,   7,   8,   9,   0,   MINS,EQL, BSPC,    CLR, EQL, PSLS,PAST,
    TAB, Q,   W,   E,   R,   T,   Y,   U,   I,   O,   P,   LBRC,RBRC,         P7,  P8,  P9,  PMNS,
    LCAP,A,   S,   D,   F,   G,   H,   J,   K,   L,   SCLN,QUOT,     FN15,    P4,  P5,  P6,  PPLS,
    LSFT,Z,   X,   C,   V,   B,   N,   M,   COMM,DOT, SLSH,          UP,      P1,  P2,  P3,  PENT,
    LCTL,LALT,               FN16,               LALT,FN31,LEFT,RGHT,DOWN,    P0,       PDOT
    ),
...
static const uint16_t fn_actions[] PROGMEM = {
    ...
    [15] = ACTION_MODS_TAP_KEY(MOD_LGUI, KC_ENTER),
    ...
    [30] = ACTION_MODS_TAP_KEY(MOD_LGUI, KC_ENTER),
    [31] = ACTION_MODS_TAP_KEY(MOD_RALT, KC_NONUS_BSLASH),
};
